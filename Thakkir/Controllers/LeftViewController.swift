...
class LeftViewController : UIViewController, LeftMenuProtocol {
    ...
    override func viewDidLoad() {
        ...
        self.swiftViewController = swiftViewController; // UINavigationController(rootViewController: swiftViewController)
...
extension LeftViewController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let menu = LeftMenu(rawValue: indexPath.item) {
            switch menu {
            case .main, .swift, .java, .go, .nonMenu:
                let cell =  tableView.dequeueReusableCell(withIdentifier: "leftcell") as! BaseTableViewCell;//BaseTableViewCell(style: UITableViewCellStyle.Subtitle, reuseIdentifier: "leftcell");//BaseTableViewCell.identifier)
